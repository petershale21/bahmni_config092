...
(
	...
	(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, 'Seen' AS 'Program_Status'
	...
	(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, 'Seen_Previous' AS 'Program_Status'
	FROM (
	(select distinct patient.patient_id AS Id,
										patient_identifier.identifier AS patientIdentifier,
										p.identifier as ART_Number,
