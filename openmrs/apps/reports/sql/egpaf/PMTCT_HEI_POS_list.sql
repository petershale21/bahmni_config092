SELECT Patient_Identifier, Patient_Name, Age, Gender, Age_at_Test, Date_Sample_Taken, ART_Start_Date
FROM (
SELECT Id, patientIdentifier AS "Patient_Identifier", patientName AS "Patient_Name", Age, Gender, Age_at_Test, Date_Sample_Taken, ART_Start_Date 
		FROM
		(
