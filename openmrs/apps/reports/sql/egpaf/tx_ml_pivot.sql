...
UNION
(
select Patient_Identifier,Patient_Name,gender,age_group,'Under3mnths' as Outcome
from(
		(SELECT patientIdentifier AS "Patient_Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Initiated' AS 'Program_Status', sort_order
			FROM
                (select distinct patient.patient_id AS Id,
...
UNION
(
select Patient_Identifier,Patient_Name,gender,age_group,'Above3mnths' as Outcome
from(
		(SELECT patientIdentifier AS "Patient_Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Initiated' AS 'Program_Status', sort_order
			FROM
                (select distinct patient.patient_id AS Id,
