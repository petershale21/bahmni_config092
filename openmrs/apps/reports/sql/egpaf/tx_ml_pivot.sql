SELECT Total_Aggregated_TxML.AgeGroup
		...
		, Total_Aggregated_TxML.IIT_GT_3_M
		, Total_Aggregated_TxML.IIT_GT_3_F		
...
FROM (
			(SELECT TX_ML_DETAILS.age_group AS 'AgeGroup'
					...
					, IF(TX_ML_DETAILS.Id IS NULL, 0, SUM(IF(TX_ML_DETAILS.Outcome = 'IIT>3m' AND TX_ML_DETAILS.Gender = 'M', 1, 0))) AS IIT_GT_3_M
					, IF(TX_ML_DETAILS.Id IS NULL, 0, SUM(IF(TX_ML_DETAILS.Outcome = 'IIT>3m' AND TX_ML_DETAILS.Gender = 'F', 1, 0))) AS IIT_GT_3_F
			...
			(SELECT 'Total' AS AgeGroup
					...
					, IF(Totals.Id IS NULL, 0, SUM(IF(Totals.Outcome = 'IIT>3m' AND Totals.Gender = 'M', 1, 0))) AS IIT_GT_3_M
					, IF(Totals.Id IS NULL, 0, SUM(IF(Totals.Outcome = 'IIT>3m' AND Totals.Gender = 'F', 1, 0))) AS IIT_GT_3_F
