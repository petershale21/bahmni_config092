(SELECT patientIdentifier AS "Patient_Identifier",ART_Number, File_Number, patientName AS "Patient_Name", Age,DOB, Gender, Treatment_Type-- , VIA_Result, PapSmear_Result
    FROM
