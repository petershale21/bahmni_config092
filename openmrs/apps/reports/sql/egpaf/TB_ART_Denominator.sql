		...
		From(
				select distinct patient.patient_id AS Id,
					...
					--  TB Clients 
						...
						AND CAST(o.obs_datetime AS DATE) >= CAST('2024-04-01' AS DATE)
						AND CAST(o.obs_datetime AS DATE) <= CAST('2024-04-30' AS DATE)
...
from obs o
	inner join
		(
		 ...
		 and cast(oss.obs_datetime as date) <= cast('2024-04-30' as date)
