SELECT Patient_Identifier, Patient_Name, Age, Age_at_Test, Gender, Date_Sample_Taken, Test_Result
FROM 
...
on test_age.person_id = HEI_Status_Detailed.Id
...
on sample_date.person_id = HEI_Status_Detailed.Id
