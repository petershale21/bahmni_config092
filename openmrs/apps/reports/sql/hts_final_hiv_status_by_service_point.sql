Select Patient_Identifier, Patient_Name, Age,Gender, age_group,HIV_Testing_Initiation,Testing_History,HIV_Status, Location_Name
from
(SELECT Id,  Patient_Identifier, Patient_Name, Age, Gender, age_group, HIV_Testing_Initiation , Testing_History , HIV_Status
FROM (
...
ORDER BY HTS_Status_Detailed.HIV_Testing_Initiation
			...
			, HTS_Status_Detailed.HIV_Status) as tested
Left Join 
(
	select distinct o.person_id, l.name as Location_Name 
	from obs o 
	INNER JOIN location l on o.location_id = l.location_id and l.retired=0
	Group by person_id
) as loc
