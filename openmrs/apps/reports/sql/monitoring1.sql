...
(
	(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'Initiated' AS 'Program_Status'
	FROM
...
(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'Seen' AS 'Program_Status'
FROM (
...
(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'MissedWithin28Days' AS 'Program_Status'
FROM
                (select distinct patient.patient_id AS Id,
									   patient_identifier.identifier AS patientIdentifier,
									   p.identifier as ART_Number,
...
(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'Seen_Prev_Months' AS 'Program_Status'
FROM (
(select distinct patient.patient_id AS Id,
									   patient_identifier.identifier AS patientIdentifier,
									   p.identifier as ART_Number,
...
(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'Transfer Out' AS 'Program_Status'
FROM (
...
(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'Transfer In' AS 'Program_Status'
FROM (
...
select distinct patient.patient_id AS Id,
				...
				from 
									...
									(	select os.person_id, CAST(max(os.value_datetime) AS DATE) as latest_transferin
										from obs os
										where os.concept_id=2396 and os.voided = 0
                                        AND MONTH(os.value_datetime) = MONTH(CAST('#endDate#' AS DATE)) 
								        AND YEAR(os.value_datetime) = YEAR(CAST('#endDate#' AS DATE)) 
										group by os.person_id
...
(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'Reinitiating Treatment' AS 'Program_Status'
FROM (
...
select distinct patient.patient_id AS Id,
				...
				from 
									...
									(	select os.person_id, CAST(max(os.value_datetime) AS DATE) as reinitiating
										from obs os
...
(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'Stopped Treatment' AS 'Program_Status'
FROM (
...
select distinct patient.patient_id AS Id,
				...
				from 
									...
									(	select os.person_id
										from obs os
										where os.concept_id=3767 and value_coded = 2297 and os.voided = 0	
										and os.person_id in (
											select person_id FROM
											(
											select os.person_id, CAST(max(os.value_datetime) AS DATE) as Stopped_Treatment
											from obs os
...
(SELECT Id,patientIdentifier AS "Patient_Identifier",ART_Number, patientName AS "Patient_Name", Age,DOB, Gender, age_group, 'Died' AS 'Program_Status'
FROM (
				...
				from 
									...
									(	
										select distinct p.person_id
											...
											where dead = 1
											and death_date <= CAST('#endDate#' AS DATE)
											AND MONTH(p.death_date) = MONTH(CAST('#endDate#' AS DATE)) 
											AND YEAR(p.death_date) = YEAR(CAST('#endDate#' AS DATE)) 
