...
(
Select VL_results.order_id as Id, patientIdentifier as "Patient Identifier",  patientName as "Patient Name",age_group, Age, Gender,Lab_Order_Number as "Lab Order Number", 
        Results,result_date as "Date Results Received", received, sort_order
From
...
(
Select VL_results.order_id as Id, patientIdentifier as "Patient Identifier",  patientName,age_group, Age, Gender,Lab_Order_Number as "Lab Order Number", 
        Results,result_date as "Date Results Received", received, sort_order
From
(select distinct patient.patient_id,
                patient_identifier.identifier AS patientIdentifier,
