...
select age_group, 
	IF(Id is null, 0,SUM(IF(Heading = 'initiated_This_Month',1,0))) AS initiated_This_Month,
	IF(Id is null, 0,SUM(IF(Heading = 'Came_For_Refill',1,0))) AS Came_For_Refill,
	IF(Id is null, 0,SUM(IF(Heading = 'MMD',1,0))) AS MMD,
	IF(Id is null, 0,SUM(IF(Heading = 'defaultedUpTo28Days',1,0))) AS defaultedUpTo28Days, 
	IF(Id is null, 0,SUM(IF(Heading = 'defaulted29to89Days',1,0))) AS defaulted29to89Days
...
from obs o 
	 ...
	 inner join patient on o.person_id = patient.patient_id
						 ...
						 and o.obs_id in (
								...
								and os.value_datetime < cast('2020-07-31' as date)
								and datediff(cast('2020-07-31' as date), os.value_datetime) between 29 and 89
						 )
