...
FROM
                (select distinct patient.patient_id AS Id,
						...
						floor(datediff(CAST('2022-03-31' AS DATE), person.birthdate)/365) AS Age,
                ...
                from obs o
						  ...
						  -- Latest followup date from the lastest followup form, exclude voided followup date
								select active_clients.person_id
										...
										(  select B.person_id, B.obs_group_id, B.value_datetime AS latest_follow_up
											...
											and obs_datetime <= cast('2022-03-31' as date)
										...
										where active_clients.latest_follow_up < cast('2022-03-31' as date)
										and DATEDIFF(CAST('2022-03-31' AS DATE),latest_follow_up) > 0
										and DATEDIFF(CAST('2022-03-31' AS DATE),latest_follow_up) <= 28
										...
										and active_clients.person_id not in (
											...
											AND MONTH(os.obs_datetime) = MONTH(CAST('2022-03-31' AS DATE)) 
											AND YEAR(os.obs_datetime) = YEAR(CAST('2022-03-31' AS DATE))
											)
										...
										and active_clients.person_id not in (
											...
											AND MONTH(os.value_datetime) = MONTH(CAST('2022-03-31' AS DATE)) 
											AND YEAR(os.value_datetime) = YEAR(CAST('2022-03-31' AS DATE))
											)
										...
										where tout_clients.latest_consultation < cast('2022-03-31' as date)
						...
						CAST('2022-03-31' AS DATE) BETWEEN (DATE_ADD(DATE_ADD(person.birthdate, INTERVAL observed_age_group.min_years YEAR), INTERVAL observed_age_group.min_days DAY))
						AND (DATE_ADD(DATE_ADD(person.birthdate, INTERVAL observed_age_group.max_years YEAR), INTERVAL observed_age_group.max_days DAY))
                   WHERE observed_age_group.report_group_name = 'Modified_Ages' and cast(value_datetime as date) <= CAST('2022-03-31' AS DATE) and concept_id = 3752 
...
FROM
                ...
                from obs o
						...
						select active_clients.person_id
								...
								where active_clients.latest_follow_up < cast('2022-03-31' as date)
								and DATEDIFF(CAST('2022-03-31' AS DATE),latest_follow_up) > 28
								and DATEDIFF(CAST('2022-03-31' AS DATE),latest_follow_up) <= 89
