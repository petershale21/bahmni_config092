...
'PrEP, Indication for stopping PrEP': function (formName, formFieldValues) {
        ...
        if ((formName == "PrEP , Intake Template") || (formName == "PrEP ,Stopping PrEP")) {
                var conditions = { show: [], hide: [] };
...
'PrEP , Pregnancy Test': function (formName, formFieldValues,patient) {
     ...
     'PrEP, Type of Transfer': function (formName, formFieldValues) {
        var EntryMode= formFieldValues['PrEP, Type of Transfer'];
        var conditions = { show: [], hide: [] };



        if ((formName == "PrEP , Follow Up Template") || (formName == "PrEP, Transfers")) {
             

                if (EntryMode =="PrEP, Transfer In" ) {
                        conditions.show.push("HIVTC, Transferred in from")
                        conditions.hide.push("HIVTC, Transferred out to")

                        

                }else if(EntryMode=="PrEP, Transfer Out") {
