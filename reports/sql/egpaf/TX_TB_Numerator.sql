SELECT Patient_Name,Program_Status,ART_Status,Gender,Age_Group
from(
-- starting tx,new on ART
(SELECT Patient_Name,Program_Status,ART_Status,Gender,'<15' as 'Age_Group'
FROM
(
(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Initiated' AS 'Program_Status','New_on_ART' as 'ART_Status', sort_order
FROM
...
(
SELECT distinct Patient_Name,Program_Status,ART_Status,Gender,'<15' as 'Age_Group'
FROM ((SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Seen' AS 'Program_Status','Already_on_ART' as 'ART_Status', sort_order
FROM (
...
(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Seen_Prev_Months' AS 'Program_Status','Already_on_ART' as 'ART_Status', sort_order
FROM (
(select distinct patient.patient_id AS Id,
                                   patient_identifier.identifier AS patientIdentifier,
                                   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
