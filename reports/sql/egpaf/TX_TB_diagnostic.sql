(SELECT Patient_Name,Smear_Only as Diagnostic_Test
FROM (

(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Initiated' AS 'Program_Status','Smear_Only', sort_order
FROM
                ...
                from obs o
						...
						select person_id
						FROM obs
						WHERE (concept_id = 3815 and value_coded = 3819)
						and voided = 0
...
(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Seen' AS 'Program_Status','Smear_Only', sort_order
FROM (
...
(SELECT distinct patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'MissedWithin28Days' AS 'Program_Status','Smear_Only', sort_order
FROM
                (select distinct patient.patient_id AS Id,
									   patient_identifier.identifier AS patientIdentifier,
									   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
...
(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Seen_Prev_Months' AS 'Program_Status','Smear_Only', sort_order
FROM (
(select distinct patient.patient_id AS Id,
                                   patient_identifier.identifier AS patientIdentifier,
                                   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
...
(SELECT Patient_Name,Xpert as Diagnostic_Test
FROM (

(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Initiated' AS 'Program_Status','Xpert', sort_order
FROM
                (select distinct patient.patient_id AS Id,
									   patient_identifier.identifier AS patientIdentifier,
									   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
                ...
                from obs o
						...
						select person_id
						FROM obs
						WHERE (concept_id = 3814 and value_coded in (3824,3825))
						and voided = 0
						and obs_datetime BETWEEN CAST('#startDate#' AS DATE) AND CAST('#endDate#' AS DATE)
						)
...
(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Seen' AS 'Program_Status','Xpert', sort_order
FROM (
...
-- INCLUDE MISSED APPOINTMENTS WITHIN 28 DAYS ACCORDING TO THE NEW PEPFAR GUIDELINE
(SELECT distinct patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'MissedWithin28Days' AS 'Program_Status','Xpert', sort_order
FROM
                (select distinct patient.patient_id AS Id,
									   patient_identifier.identifier AS patientIdentifier,
									   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
...
(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Seen_Prev_Months' AS 'Program_Status','Xpert', sort_order
FROM (
(select distinct patient.patient_id AS Id,
                                   patient_identifier.identifier AS patientIdentifier,
                                   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
...
UNION
(
SELECT Patient_Name,'Other(No Xpert)' as Diagnostic_Test
FROM (

(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Initiated' AS 'Program_Status','Other(No Xpert)', sort_order
FROM
                (select distinct patient.patient_id AS Id,
									   patient_identifier.identifier AS patientIdentifier,
									   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
                ...
                from obs o
						...
						select person_id
						FROM obs
						WHERE (concept_id = 3815 and value_coded = 1045)
						and voided = 0
						and obs_datetime BETWEEN CAST('#startDate#' AS DATE) AND CAST('#endDate#' AS DATE)
						)
...
(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Seen' AS 'Program_Status','Other(No Xpert)', sort_order
FROM (
...
-- INCLUDE MISSED APPOINTMENTS WITHIN 28 DAYS ACCORDING TO THE NEW PEPFAR GUIDELINE
(SELECT distinct patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'MissedWithin28Days' AS 'Program_Status','Other(No Xpert)', sort_order
FROM
                (select distinct patient.patient_id AS Id,
									   patient_identifier.identifier AS patientIdentifier,
									   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
...
(SELECT patientIdentifier AS "Patient Identifier", patientName AS "Patient_Name", Age, Gender, age_group, 'Seen_Prev_Months' AS 'Program_Status','Other(No Xpert)', sort_order
FROM (
(select distinct patient.patient_id AS Id,
                                   patient_identifier.identifier AS patientIdentifier,
                                   concat(person_name.given_name, ' ', person_name.family_name) AS patientName,
